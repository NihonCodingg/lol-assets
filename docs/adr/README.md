...
| [0023](0023-uma-fatia-por-campeao.md) | **Uma fatia por campeão**: abrir um campeão busca só a fatia dele, apontada pelo catálogo; contrato 2.0.0 | ✅ aceito — exceção única ao 0021, não é precedente; emenda o 0010 e a §6.1 da Spec |
| [0024](0024-a-direcao-visual-do-bin.md) | **A direção visual: o bin do editor**: grafite, destaque magenta `#F072B3`, oito cores de etiqueta, Schibsted Grotesk, o quadro como única ousadia | ✅ aceito — substitui a direção da Onda 7 e a trava do TOKENS.md |
